# Contributing to `sense-base/sense-template`.

👍🎉 First off, thanks for taking the time to contribute! 🎉👍

When contributing to this repository, please first discuss the change you wish to make via issue or other method with the owners of this repository before making a change. 
...
```
git clone git@github.com:sense-base/sense-template.git
```

## New issues
* Open an issue (bug report, feature request, or something is not working): https://github.com/sense-base/sense-template/issues/new/choose
...
9.1 You can navigate branches in https://github.com/sense-base/sense-template/branches and removed merged branches by clickling :wastebasket: icon.    
